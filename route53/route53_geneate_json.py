...
## --
## Created : <2017-10-31>
## Updated: Time-stamp: <2017-10-31 16:15:24>
##-------------------------------------------------------------------
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--value', required=True, help="DNS CNAME to delete", type=str)
    l = parser.parse_args()
    generate_new_file("aws_dns_tmpl.json", "aws_dns.json", l.cname, l.value)
